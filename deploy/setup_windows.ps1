...
# --- 5. Install MetaTrader5 Python package -----------------------------------
...
Write-Host "  1. Install MetaTrader 5:" -ForegroundColor Green
Write-Host "     https://www.metatrader5.com/en/download" -ForegroundColor Green
Write-Host "     Log in with your broker, enable Expert Advisors." -ForegroundColor Green
Write-Host "" -ForegroundColor Green
Write-Host "  2. Install services (run as Admin):" -ForegroundColor Green
Write-Host "     & C:\katraswing\deploy\install_services.ps1" -ForegroundColor Green
Write-Host "" -ForegroundColor Green
Write-Host "  3. Open dashboard:" -ForegroundColor Green
Write-Host "     http://<your-azure-ip>:8501" -ForegroundColor Green
Write-Host "============================================================" -ForegroundColor Green
